...
def evaluate_future_action(board, depth):
    if depth == 0:
    ...
    for i in range(-5, 5):
        for n in range(0, 4):
            ...
            future_score = evaluate_future_action(tempBoard, depth - 1)
        ...
        try:
            for i in range(-5, 5):
                for n in range(0, 4):
                    ...
                    future_score = evaluate_future_action(tempBoard, 1)
                    if future_score < temph:
                        mmx = maxhight
                        temph = future_score
                        tempRotate = n
                        tempmove = i
